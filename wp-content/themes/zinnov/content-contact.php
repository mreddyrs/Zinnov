...
<input type="hidden" name="_wpcf7_container_post" value="0">
                          ...
                          <div class="form-group"> 
                            ...
                            <input id="yourname" name="yourname" type="text" required placeholder="Enter your full name" class="form-control input-field">
                          </div>
                  ...
                  <div class="col-sm-5">
                    <div class="row">
                      <div class="contact-form-content-container">
                        ...
                        </div><a href="<?php echo get_field('button_url');?>" class="btn btn--lg btn--blue"><?php echo get_field('button_text');?></a>
                      </div>
                    </div>
                  </div>
                </div>
