...
?>
  ...
  <main>
     ...
     <h3 class="heading heading--black text-capitalize heading--lg">questions answered</h3>
                <div class="row">
                  <div class="col-sm-9">
      ...
      $the_query=new WP_Query(array('post_type'=>'faq'));
            ...
            {  
              ...
              ?> 
                      ...
                      <!--   <li class="faq-qa-menu__list">
                          ...
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title">cost/billing</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item"><a href="#cost-billing " class="faq-qa-list__link">How much is the subscription fee for DRAUP?</a></li>
                              </ol>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="faq-qa-menu__list">
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title">Data and Updates</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item"><a href="#data-updates" class="faq-qa-list__link"> How often is the DRAUP database updates?</a></li>
                              </ol>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="faq-qa-menu__list">
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title"> SUBSCRIBTION</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item"><a href="#subscription" class="faq-qa-list__link">Can I individually subscribe to DRAUP ?</a></li>
                              </ol>
                            </div>
                          </div>
                        </li>
                        <li class="faq-qa-menu__list">
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title">SECTORS</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list faq-qa-list--last">
                                <li class="faq-qa-list__item"><a href="#sector" class="faq-qa-list__link">What verticals or sectors does DRAUP Cover?</a></li>
                              </ol>
                            </div>
                          </div>
                        </li>-->
              ...
              ?> 
                      ...
                      <!--   <li id="cost-billing" class="faq-qa-menu__list"> 
                            ...
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item">
                                  ...
                                  <p class="info">Depending on the modules, verticals as well as number of licenses, the subscription fee varies. Mail us on info@draup.com for further details.</p>
                                </li>
                              </ol>
                            </div>
                          </div>
                        ...
                        <li id="data-updates" class="faq-qa-menu__list"> 
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title">data updates</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                        ...
                        <li id="subscription" class="faq-qa-menu__list">
                          <div class="col-sm-3">
                            <div class="row">
                              <h3 class="faq-title">subscription</h3>
                            </div>
                          </div>
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item">
                                  <h4 class="qa-menu__heading">Can I individually subscribe to DRAUP ?</h4>
                                  <p class="info">Currently, access to DRAUP is limited to organisation who have to pay an annual fee.</p>
                                </li>
                              </ol>
                            </div>
                          </div>
                        ...
                        <li id="sector" class="faq-qa-menu__list">
                          ...
                          <div class="col-sm-9">
                            <div class="row">
                              <ol class="faq-qa-list">
                                <li class="faq-qa-list__item">
                                  <h4 class="qa-menu__heading">What verticals or sectors does DRAUP Cover?</h4>
                                  <p class="info">DRAUP Subscription is categorized by Contexts  and Verticals. Currently, DRAUP Platform support 3 contexts and 3 Verticals</p>
                                  <ol class="faq-qa-list-menu">
                                    <li class="faq-qa-list-menu__item info">Contexts: Engineering Services, Digital Technology Services and Digital Products</li>
                                    <li class="faq-qa-list-menu__item info">Verticals: Automotive, Enterprise Software, Internet & Consumer Software</li>
                                  </ol>
                                </li>
                              </ol>
                            </div>
