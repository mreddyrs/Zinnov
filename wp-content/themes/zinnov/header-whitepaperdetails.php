...
<html <?php language_attributes(); ?> class="no-js">
 <head>
      ...
      <title>Draup - White Paper Details</title>
        ...
        <div class="container">
            ...
            <div class="navbar-brand navbar-brand--logo"><a href="<?php echo site_url(); ?>">
                ...
                <svg id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 115 44" style="enable-background:new 0 0 115 44;" xml:space="preserve" class="header-logo">
                  <style type="text/css">
                    ...
                    .st1{clip-path:url(#SVGID_4_);fill:#B5B9BF;}
                    .st2{clip-path:url(#SVGID_6_);}
                    .st3{clip-path:url(#SVGID_8_);fill:#B5B9BF;}
                    .st4{clip-path:url(#SVGID_10_);}
                    .st5{clip-path:url(#SVGID_12_);fill:#B5B9BF;}
                    .st6{clip-path:url(#SVGID_14_);}
                    .st7{clip-path:url(#SVGID_16_);fill:#B5B9BF;}
                    .st8{clip-path:url(#SVGID_18_);}
                    .st9{clip-path:url(#SVGID_20_);fill:#B5B9BF;}
                    .st10{clip-path:url(#SVGID_22_);}
                    .st11{clip-path:url(#SVGID_24_);fill:#6DCEF9;}
                    .st12{clip-path:url(#SVGID_26_);}
                    .st13{clip-path:url(#SVGID_28_);fill:#6DCEF9;}
                  </style>
                  <g>
                    <g>
                      <defs>
          ...
          <div id="zinnov-menu" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-right nav">
              <li class="nav__list"><a href="<?php echo get_option( 'siteurl' );?>/about" class="nav__link">About</a></li>
              <li class="nav__list"><a href="<?php echo get_option( 'siteurl' );?>/blog" class="nav__link">blog</a></li>
              <li class="nav__list active"><a href="<?php echo get_option( 'siteurl' );?>/whitepapers" class="nav__link">white Papers </a></li>
              <li class="nav__list"><a href="<?php echo get_option( 'siteurl' );?>/faq" class="nav__link">FAQ</a></li>
              <li class="nav__list"><a href="<?php echo get_option( 'siteurl' );?>/contact" class="nav__link">Contact</a></li>
              <li class="nav__list nav__list--las"><a href="<?php echo get_option( 'siteurl' );?>/requestdemo" class="nav__link">REQUEST a demo</a></li>
              <li class="nav__list nav-list-last"><a href="<?php echo site_url(); ?>" class="nav__link">login </a></li>
            </ul>
          </div>
        </div>
      </nav>
