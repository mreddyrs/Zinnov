...
<body <?php body_class(); ?>>
   <!--START: Header-->
    <header class="header">
      <nav role="navigation" class="navbar navbar--menu navbar--green">
        <!--START: Container-->
        <div class="container">
          ...
          <div id="zinnov-menu" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-right nav">
              ...
              <li class="nav__list active"><a href="<?php echo get_option( 'siteurl' );?>/contact" class="nav__link">Contact</a></li>
