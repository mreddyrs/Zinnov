...
<body<?php body_class(); ?>>
 ...
 <!--START: Header-->
    <header id="about" class="header">
      <nav role="navigation" class="navbar navbar--menu navbar--orange">
        <!--START: Container-->
        <div class="container">
          ...
          <div id="zinnov-menu" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-right nav">
              <li class="nav__list active"><a href="<?php echo get_option( 'siteurl' );?>/about" class="nav__link">About</a></li>
