        ...
        <div class="container">
          ...
          <div id="zinnov-menu" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-right nav">
              ...
              <li class="nav__list"><a href="<?php echo get_option( 'siteurl' );?>/whitepapers" class="nav__link">white Papers </a></li>
              <li class="nav__list active"><a href="<?php echo get_option( 'siteurl' );?>/faq" class="nav__link">FAQ</a></li>
